...
- [docs/releases/](docs/releases/) - release notes, for people who read changelogs voluntarily.
...
- [docs/admin-headache.en.md](docs/admin-headache.en.md) - security/admin side effect of a messenger that is just an HTML file.
...
- [docs/admin-headache.md](docs/admin-headache.md)
