...
## Структура demo repository

Файлы Macaroni живут в `.macaroni/`, поэтому messenger можно приделать к любому repository и не засрать root.
...
Demo data захардкожен внутри `messenger.html`; настоящий подключённый repository использует тот же layout.
