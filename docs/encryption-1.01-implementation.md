...
Этот документ - мост между манифестом Encryption 1.01 и будущим кодом.
...
В repo не оставляем тестовую простыню ради фичи, которая ещё не написана.

Когда фича станет реальным кодом, smoke harness можно расширить отдельным решением.
