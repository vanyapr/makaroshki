...
Языковая договорённость: английский является дефолтным языком `README.md`, `index.html` и пользовательского интерфейса `messenger.html`. Русские документы сохраняются как локализация и исторический контекст, но новый пользовательский вход по умолчанию английский.
