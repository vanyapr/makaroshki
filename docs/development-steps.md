...
Текущая UI-договорённость для мобильной версии: sidebar не растягивает список чатов пустотой, чаты идут компактной горизонтальной лентой, composer полностью помещается в экран.
