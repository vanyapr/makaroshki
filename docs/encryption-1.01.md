...
Если локально есть write token, Encryption 1.01 может использовать его как источник локального confetti перед шифрованием.
...
Отсутствие token не выключает шифрование.
